...
export const MOCK_OVERVIEW: OverviewData = {
  ...
  indices: [
    ...
    { code: "000016", name: "上证50", value: 2625.10, change: 12.40, changePct: 0.47, sparkline: [23,21,22,17,19,15,16,11,13,8,10,5] },
    ...
    { code: "932000", name: "中证2000", value: 2415.80, change: -18.90, changePct: -0.78, sparkline: [9,7,11,10,15,14,19,17,22,21,25,28] },
    { code: "HSI", name: "恒生指数", value: 19876.54, change: 142.30, changePct: 0.72, sparkline: [24,22,23,18,20,16,17,12,14,9,11,6] },
    { code: "HSTECH", name: "恒生科技", value: 4605.15, change: 33.40, changePct: 0.73, sparkline: [23,21,22,16,18,13,15,9,11,6,8,3] },
  ],
  breadth: {
